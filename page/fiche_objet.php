    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <?php if (!empty($images)) { ?>
                    <img src="<?php echo $images[0]['url']; ?>" class="img-fluid mb-2" alt="Image principale">
                <?php } else { ?>
                ...
                <?php if (count($images) > 1) { ?>
                    ...
                    <div class="d-flex flex-wrap">
                        <?php for ($i = 1; $i < count($images); $i++) { ?>
                            <img src="<?php echo $images[$i]['url']; ?>" class="img-thumbnail me-2 mb-2" style="max-width: 100px;" alt="Autre image">
                        <?php } ?>
                    </div>
                <?php } ?>
            </div>
